  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className="flex m-8 items-center justify-center gap-4 text-2xl text-white">
        <a href="https://www.linkedin.com/in/bikram-10-bhusal/" target="_blank">
          <FaLinkedin />
        </a>
        <a href="https://github.com/bikki10" target="_blank">
          <FaGithub />
        </a>
        <a href="https://www.facebook.com/bikki75.bikram" target="_blank">
          <FaFacebook />
        </a>
        <a href="https://www.instagram.com/_bikki10/" target="_blank">
          <FaInstagram />
        </a>
      </div>
    </nav>
